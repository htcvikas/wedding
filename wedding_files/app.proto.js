...
SimpleAppProto.prototype.openLink = function(href, target, linkType, e,anchorData,mainPageId, renderedLink){
	...
	switch (linkType){
		case 'PAGE':
			Wix.navigateToPage(renderedLink && renderedLink.pageId && renderedLink.pageId.id || mainPageId);
			break;
        case 'ANCHOR':
			var pageId = renderedLink && renderedLink.pageId && renderedLink.pageId.id || mainPageId;
